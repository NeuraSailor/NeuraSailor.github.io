重点掌握
![[Pasted image 20251124100137.png|300]]
分析相关性：
![[Pasted image 20251124100734.png|300]]

![[Pasted image 20251124104501.png|300]]
[[notebooklm：总结]]
## 方差定义
Var（X）或 D (X)
...
| 分布类型 (Distribution)                  | 概率密度函数 $f(x)$ 或 分布律 $P\{X=k\}$                                        | 数学期望 $E[X]$         | 方差 $Var[X]$           | 随机变量 $X$                                     | 分布函数 $F(x)$ (CDF)                              |
| :----------------------------------- | :-------------------------------------------------------------------- | :------------------ | :-------------------- | :------------------------------------------- | :--------------------------------------------- |
