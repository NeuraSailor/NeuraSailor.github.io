...
![|250](../../assets/20250909151703489.png)  

#### 编写功能包  

##### 创建节点 `python_node.py`

![|375](../../assets/20250909153643924.png)
...
在 setup. Py 中声明  
![|725](../../assets/20250909154500438.png)

' 节点名 = 功能包名. 节点名. 函数名 '

在功能包清单文件 package. Xml 中添加依赖 (非必要)

![|725](../../assets/20250909155049638.png)
...
![1757404332138_d.png|300](../../assets/20250909155400994.png)

**注意注意，进行到这里，install 文件为最终单独有用的文件**  把 install 文件复制给别人，别人就可以直接运行功能包了  
Install 文件内部：  
![1757405100466_d.png|300](../../assets/20250909160503404.png)
