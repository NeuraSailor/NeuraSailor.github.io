---
MIT课程: https://www.youtube.com/watch?v=GtOGurrUPmQ&list=PLyQSN7X0ro203puVhQsmCj9qhlFQ-As8e&index=2
学长笔记: https://savia7582.github.io/Exterior/
智云课堂: https://classroom.zju.edu.cn/searchContent?title=%E5%A4%A7%E5%AD%A6%E7%89%A9%E7%90%86&realname=&trans=&page=1&tenant_code=112
文本: 序号 B52；小测 15min

基础资料:
  - "[[IMG_20250218_104216.jpg]]"
  - "[[IMG_20250218_104947.jpg]]"
  - "[[IMG_20250218_105625.jpg]]"
  - "[[image 4.png]]"
错题: 题目收藏：P36 1.12;p86 2.18 p128 2.50,P117 2.26P198 3.49
拓展方向: 附录1.A科里奥利力
---
# 第一周：质点运动学
...
- 圆周运动（注意：w,$\beta$等概念只在圆周运动中有效）
    ...
    ![image|300](../../assets/20250422080100898.png)
...
\vec v=\vec v’+\vec u$; $\vec a=\vec a’+\vec a_0$
    ...
    ![image 1|300](../../assets/20250422080100899.png)
...
![1740404148461_d|300](../../assets/20250422080100900.jpg)
...
- 转动惯量
    ...
    - 典型特殊转动惯量
        ...
        ![image 2|300](../../assets/20250422080100901.png)
...
- 刚体定轴转动动能定理
    ...
    $A_外=
$$\int ^\theta _{\theta_0}Md\theta$=$\Delta(1/2Jw^2)$
...
> [!important] 一般的：
> 
> ![image 3|300](../../assets/20250422080100902.png)
> 
...
![1743736729233_d|300](../../assets/20250422080100903.jpg)
    
由x0确定$\phi$的大小，由v0确定$\phi$的方向

旋转矢量法：v方向为x逆时针$\pi/2$，a方向为v逆时针$\pi/2$
![1745456327215_d.jpg|300](../../assets/20250424085906949.jpg)
...
### 动力学规律：
#### 对细棒（代表纵波）：
![1745504111470_d.jpg|300](../../assets/20250424221518574.jpg)
...
![1745541567447_d.jpg|300](../../assets/20250425083933860.jpg)
...
**+振幅相等+沿相反方向传播**
  ...
  基于上面两个条件，能遇到比较好的和差化积的形式：   ![](../../assets/20250423233315903.png)
...
2. 两端点固定的驻波：
  ...
  4. ![|300](../../assets/20250424192008165.png)
...
2 A \cos \frac{2\pi}{\lambda} (L-x) \cos (\omega t - \frac{2\pi}{\lambda} L)$
  ...
  4. ![|300](../../assets/20250424191849883.png)
...
![|300](../../assets/20250504143532799.png)
#### 作用
...
#### 三种特征速率
![|300](../../assets/20250504151420758.png)
![|400](../../assets/20250506174815926.png)
...
# 热力学基础
## 准静态过程
![](../../assets/20250508084319392.png)
## 热力学第一定律V
![](../../assets/20250512195325851.png)

## 计算热量
$Q=\Delta E-A$
### 摩尔热容量
![|500](../../assets/20250512195615373.png)
plus：**气体摩尔热容可以是负值（放热）**
### 定体摩尔热容
没有做功，A=0
...
![|500](../../assets/20250512202511657.png)
$pV^\gamma$和$TV^{\gamma-1}$为常量

#### 等温线与绝热线比较

绝热线斜率>等温线斜率
![|500](../../assets/20250512203122065.png)

### 总结
![|700](../../assets/20250512203206038.png)

### 解题技巧
![|400](../../assets/20250512203259417.png)
